...
Route::group(['middleware' => ['install']], function () {
	...
	Route::group(['middleware' => ['auth', 'verified']], function () {
		...
		Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
			...
			//Member Controller
			Route::match(['get', 'post'], 'members/import', 'MemberController@import')->name('members.import');
		...
		Route::group(['middleware' => ['customer'], 'prefix' => 'portal'], function () {
			...
			Route::post('transfer/get_final_amount', 'Customer\TransferController@get_final_amount')->name('transfer.get_final_amount');
