...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" class="validate" autocomplete="off" action="{{ action('WithdrawMethodController@update', $id) }}" enctype="multipart/form-data">
					{{ csrf_field()}}
												...
												@if($withdrawmethod->chargeLimits()->count() > 0)
													...
													<tr>
														<td>
															...
															<input type="text" class="form-control float-field" placeholder="{{ _lang('Minimum Amount') }}" name="minimum_amount[]" value="{{ $withdrawmethod->minimum_amount }}" required>
														</td>
														<td>
															<input type="text" class="form-control float-field" placeholder="{{ _lang('Maximum Amount') }}" name="maximum_amount[]" value="{{ $withdrawmethod->maximum_amount }}" required>
														</td>
														<td>
															<input type="text" class="form-control float-field" placeholder="{{ _lang('Fixed Charge') }}" name="fixed_charge[]" value="{{ $withdrawmethod->fixed_charge }}" required>
														</td>
														<td>
															<input type="text" class="form-control float-field" placeholder="{{ _lang('Charge') }} (%)" name="percent_charge[]" value="{{ $withdrawmethod->charge_in_percentage }}" required>
														</td>
