			...
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						...
						<h4 class="pt-1 mb-0"><b>{{ moneyFormat(request_count('total_loan_amount')) }}</b></h4>
					</div>
					<div>
						<a href="{{ route('loans.index') }}"><i class="ti-arrow-right"></i>&nbsp;{{ _lang('View') }}</a>
					</div>
			...
			<div class="card-body">
				<div class="d-flex">
					<div class="flex-grow-1">
						...
						<h4 class="pt-1 mb-0"><b>{{ moneyFormat(request_count('total_account_balance')) }}</b></h4>
					</div>
					<div>
				...
				<div class="table-responsive">
					...
					@foreach($recent_transactions as $transaction)
						...
						<tr>
							...
							<td class="text-center"><a href="{{ action('TransactionController@show', $transaction->id) }}" target="_blank" class="btn btn-outline-primary btn-xs"><i class="ti-arrow-right"></i>&nbsp;{{ _lang('View') }}</a></td>
						</tr>
					@endforeach
					</tbody>
					</table>
