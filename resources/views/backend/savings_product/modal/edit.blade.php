<form method="post" class="ajax-screen-submit" autocomplete="off" action="{{ action('SavingsProductController@update', $id) }}" enctype="multipart/form-data">
	{{ csrf_field()}}
	...
	<div class="row px-2">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="number" class="form-control" name="interest_rate" value="{{ $savingsproduct->interest_rate }}">
			</div>
		</div>
