...
class SavingsAccountController extends Controller {
    ...
    public function get_table_data() {
        ...
        return Datatables::eloquent($savingsaccounts)
            ...
            ->addColumn('balance', function ($savingsaccount) {
                return decimalPlace(get_account_balance($savingsaccount->id, $savingsaccount->member_id), currency($savingsaccount->savings_type->currency->name));
            })
            ...
            ->addColumn('action', function ($savingsaccount) {
                ...
                . '<a class="dropdown-item ajax-modal" href="' . action('SavingsAccountController@edit', $savingsaccount['id']) . '" data-title="' . _lang('Account Details') . '"><i class="ti-pencil-alt"></i> ' . _lang('Edit') . '</a>'
                . '<a class="dropdown-item ajax-modal" href="' . action('SavingsAccountController@show', $savingsaccount['id']) . '" data-title="' . _lang('Update Account') . '"><i class="ti-eye"></i>  ' . _lang('View') . '</a>'
                . '<form action="' . action('SavingsAccountController@destroy', $savingsaccount['id']) . '" method="post">'
                . csrf_field()
