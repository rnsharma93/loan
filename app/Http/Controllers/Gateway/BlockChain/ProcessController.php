...
class ProcessController extends Controller {
    ...
    public static function process($deposit) {
        ...
        $secret = "KJSHY5416ao2dsf7hg65dssA";
        ...
        if (!$resp) {
            $deposit->delete();
            $data['error']         = true;
            $data['error_message'] = _lang('Please use valid XPUB and API KEY !');
        ...
        $data['qr_code']     = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$response->address&choe=UTF-8";
    ...
    public function callback(Request $request) {
        ...
        $my_secret = 'KJSHY5416ao2dsf7hg65dssA';
