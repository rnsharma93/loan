...
class LoanCalculator {
    ...
    public function get_fixed_rate() {
        ...
        for ($i = 0; $i < $this->term; $i++) {
            ...
            //update date for Febuaray month
            /*
            ...
            */
            //choose last date of every month if date choose if 31st or 28 for Feb month
            $startDate->modify('first day of next month');
            
            // If the selected day is not valid in the next month, set the date to the last day of the month
            if ($day > $startDate->format('t')) {
